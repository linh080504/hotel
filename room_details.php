...
<head>
    ...
    <title>TJ Hotel - ROOM DETAIL</title>
...
<div class="container">
  ...
  <div id="roomCarousel" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <?php 
            ...
            if(mysqli_num_rows($img_q) > 0) {
                $active_class = 'active'; // Đặt class active chỉ cho mục đầu tiên
                while($img_res = mysqli_fetch_assoc($img_q)) {
                    echo "
                    <div class='carousel-item $active_class'>
                        <img src='".ROOMS_IMG_PATH.$img_res['image']."' class='d-block w-100'>
                    </div>";
                    $active_class = ''; // Xóa active sau lần lặp đầu tiên
                }
            } else {
    ...
    <div class ="col-lg-5col-md-12 px-4 ">
        <div class ="card mb-4 border-0 shadow-sm rounded=3">
            <div class="card-body">
                <?php 
                 echo<<<price
                 <h4>$room_data[price] per nigt</h4>
                price;
        ...
        <div class="col-12 mt-4 px-4">
                ...
                <div class="mb-3">Review Rating</div>
                <div>
