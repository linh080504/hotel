...
<head>
    ...
    <title>TJ Hotel - HOME - FACILITIES</title>
            ...
            <form>
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-2 mb-3">
                        <label class="form-label" style="font-weight: 500">Chidren</label>
                        <select class="form-select shadow-none">
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                ...
                <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                            ...
                            <a href="rooms_detail.php?id=$room_data[id]" class="btn btn-sm btn-outline-dark shadow-none">More details</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container">
    <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            <?php
                $res = mysqli_query($con, "SELECT * FROM `facilities`  ORDER BY `id`DESC LIMIT 5"); // Lấy tất cả bản ghi từ bảng facilities
                $path = FACILITIES_IMG_PATH;   // Đường dẫn hình ảnh

                while ($row = mysqli_fetch_assoc($res)) {
                    echo <<<data
                    <div class="col-lg-2 text-center col-md-2 bg-white rounded shadow py-4 my-3">
    ...
    <div class="swiper-wrapper mb-5">
      <div class="swiper-slide bg-white p-4">
        ...
        <p>
            ...
            Est cumque minus obcaecati quia deleniti sequi itaque veniam, 
            magnam porro quo!
        </p>
        <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
